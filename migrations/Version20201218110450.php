 ...
 */
final class Version20201218110450 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE fablab (id INT AUTO_INCREMENT NOT NULL, siret VARCHAR(14) NOT NULL, category VARCHAR(255) NOT NULL, address LONGTEXT NOT NULL, name VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, schedule VARCHAR(255) DEFAULT NULL, phone VARCHAR(15) DEFAULT NULL, mail VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
